...
function army_body_fat_calculator($content)
{
	wp_enqueue_style( 'bodyfat' );
		...
		<div id="calculate">
			<div class="container">
				<div class="calculate--wrapper">
					<div class="calculate--wrapper__content">
						<div class="content-left">
							<form action="#" class="form army-body-calculate">
								<div class="column">
									<div class="label-wrapper">
										<label for="" class="label">Height</label>
									</div>
								...
								<div class="action">
									<button id="btnArmyBodyFat" disabled="disabled" class="btn-primary" type="button">
										Calculate
									</button>
									<button id="btnClear" class="btn-secondary" type="button">
										Clear
